import { Eye, MousePointerClick, Users2, TrendingUp } from "lucide-react";
...
export default async function AnalyticsPage() {
  ...
  const published = posts.filter((post) => post.status === "published").sort((a, b) => b.viewCount - a.viewCount);
  return (
