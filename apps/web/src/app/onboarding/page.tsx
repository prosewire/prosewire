        ...
        {!creatingWorkspace && workspace && canCreatePublication ? (
          ...
          <div className="card mt-8 p-6">
            <p className="text-sm font-semibold">
              This workspace has no publications yet.
            </p>
            <p className="mt-2 text-sm leading-6 text-[#69757a]">
              Ask a workspace owner or admin to create the first publication.
              Your <span className="font-semibold capitalize">{role}</span> role
              does not include publication management.
            </p>
          </div>
        ) : (
          <form
