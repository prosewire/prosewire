...
| --- | --- | --- | --- |
| Next.js package | Native App Router or Pages Router routes in about five minutes | None | Your application, with optional unstyled defaults |
| Astro integration | Native static or server-rendered Astro routes in about five minutes | None | Your application, with optional unstyled defaults |
...
- Choose the [Next.js package](/docs/integrate/nextjs/) for App Router metadata and caching or Pages Router ISR.
- Choose the [Astro integration](/docs/integrate/astro/) for injected routes or components that fit an existing layout.
