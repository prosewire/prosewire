...
| Workflow history retention | Daily scans clear terminal email workflow messages and replies after thirty days, scrub the delivery payload, preserve outbox deduplication records, and resume interrupted cleanup; active executions remain intact |
